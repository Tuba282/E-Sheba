...
const Choise = () => {
    return (
        <div
                ...
                <div className="w-full lg:w-[50%] lg:h-[450px] lg:p-15 flex flex-col gap-8  p-5 items-center">
                    ...
                    <div className="flex flex-col gap-7">
                        <div className="flex items-center gap-6 text-xs sm" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <div className="flex items-center gap-6 text-xs sm" data-aos="fade-up" data-aos-duration="2000">
                            <img src="/emojione.png" className="w-5 h-5 " alt="" />
                            <div className="  text-xs sm">
                                Use limited-time offers or exclusive deals to prompt immediate action.
                            </div>
                        </div>
                        <div className="flex items-center gap-6 text-xs sm" data-aos="fade-up" data-aos-duration="2500">
                            <img src="/emojione.png" className="w-5 h-5 " alt="" />
                            <div className="  text-xs sm">
                                Use limited-time offers or exclusive deals to prompt immediate action.
                            </div>
                        </div>
                        <div className="flex items-center gap-6 text-xs sm" data-aos="fade-up" data-aos-duration="3000">
                            <img src="/emojione.png" className="w-5 h-5 " alt="" />
                            <div className="  text-xs sm">
                                Use limited-time offers or exclusive deals to prompt immediate action.
                            </div>
